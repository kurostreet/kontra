/* KONTRA SITE v35 — OFFLINE ECONOMY + MARKET FIX */
(() => {
  "use strict";
  ...
  async function runLvlShopAction(category, itemId) {
    ...
    try {
      ...
      const map = {
        ...
        invalid_action: lvlLocalized("На сервере загружен старый WEB bridge. Нужен v10.", "An old WEB bridge is loaded on the server. v10 is required."),
