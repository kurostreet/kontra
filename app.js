...
(() => {
  ...
  const LVL_SHOP_OPTION_KEYS = Object.freeze({
    prefix:"prefix", prefcolor:"prefixColor", skin:"ctSkin", skincolor:"skinColor", crit:"critBullet", minimap:"minimap", wsound:"weaponSounds", knife:"knife"
  });
  ...
  function lvlCategoryIcon(category) {
    return ({ upgrades: "↑", crate: "✚", prefix: "TAG", prefcolor: "◐", skin: "◉", skincolor: "◈", crit: "✦", minimap: "▦", wsound: "♪", knife: "KNF" })[String(category || "")] || "◇";
  }
  ...
  const LVL_MANAGED_FIELDS = new Set(["prefix", "prefixColor", "ctSkin", "skinColor", "critBullet", "minimap", "weaponSounds", "knife"]);
  ...
  function renderLvlSettingsSummary() {
    ...
    const defs = [
      ...
      ["skinColor", t("skinColorSetting")], ["critBullet", t("critBulletSetting")], ["minimap", t("minimapSetting")], ["weaponSounds", t("weaponSoundsSetting")], ["knife", lvlLocalized("НОЖ КТ", "CT KNIFE")]
    ];
